...
//Можно записать так:  Одновременно и прибавляется и присваивается
...
console.log(itemA == itemB); // Оператор сравнения преобразовывает
// обе переменных в число
...
console.log(null == undefined); //Типы будут равны, и не равны больше ничему
*/
...
console.log(null == 0);
console.log(null >= 0);
//Тут идет преобразование к числам
*/
